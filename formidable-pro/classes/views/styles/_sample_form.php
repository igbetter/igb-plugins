...
<div class="frm_form_field frm_section_heading form-field frm_half">
	<h3 class="frm_pos_top frm_trigger active frm_section_spacing">
		...
		echo ' ';
		$collapse_icon           = isset( $atts['style']->post_content['collapse_icon'] ) ? $atts['style']->post_content['collapse_icon'] : 1;
		$icon_visible_svg_slug   = FrmStylesHelper::icon_key_to_class( $collapse_icon, '+' );
		$icon_invisible_svg_slug = FrmStylesHelper::icon_key_to_class( $collapse_icon, '-' );
		FrmProAppHelper::get_svg_icon( $icon_visible_svg_slug, 'frmsvg frm-svg-icon', $svg_args );
		FrmProAppHelper::get_svg_icon( $icon_invisible_svg_slug, 'frmsvg frm-svg-icon', $svg_args );
		unset( $collapse_icon, $icon_visible_svg_slug, $icon_invisible_svg_slug );
		?>
	</h3>
